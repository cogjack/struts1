 ...
 * with standard Spring MVC patterns.
 */
@Controller
public class RegistrationController {
    ...
    /**
     * Display the registration form. In "Create" mode, shows an empty form.
     * In "Edit" mode, populates the form from the logged-in user's profile.
     */
    ...
    /**
     * Process the registration form submission. Validates form fields via
     * Bean Validation, performs additional business-rule checks (password
     * required on Create, username uniqueness), then creates or updates
     * the user profile.
     */
