...
/**
 * Validates that the password and password2 fields on a RegistrationForm match.
 * Both null is considered valid (passwords are optional during Edit).
 * One null and one non-null, or mismatched values, produce a violation
 * on the password2 property node.
 */
