 ...
 * This interface defines the contract for user entities in the application.
 */
public interface User {
     ...
     * @throws IllegalArgumentException if the host name is not unique for this user
     */
     ...
     * @return The subscription for the host, or null if not found
     */
     ...
     * @throws IllegalArgumentException if the specified subscription is not associated with this User
     */
